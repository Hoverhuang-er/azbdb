...
type SQLiteValue struct {
	...
	Type Type    `protobuf:"varint,1,opt,name=Type,proto3,enum=hoverhuang.azb.v1.Type" json:"Type,omitempty"`
...
var file_v1_node_proto_goTypes = []interface{}{
	(Type)(0),                   // 0: hoverhuang.azb.v1.Type
	(*Node)(nil),                // 1: hoverhuang.azb.v1.Node
	(*SQLiteValue)(nil),         // 2: hoverhuang.azb.v1.SQLiteValue
	(*CRDTValue)(nil),           // 3: hoverhuang.azb.v1.CRDTValue
	(*Row)(nil),                 // 4: hoverhuang.azb.v1.Row
	(*ColumnValue)(nil),         // 5: hoverhuang.azb.v1.ColumnValue
	nil,                         // 6: hoverhuang.azb.v1.Row.ColumnValuesEntry
	(*durationpb.Duration)(nil), // 7: google.protobuf.Duration
}
var file_v1_node_proto_depIdxs = []int32{
	2, // 0: hoverhuang.azb.v1.Node.key:type_name -> hoverhuang.azb.v1.SQLiteValue
	3, // 1: hoverhuang.azb.v1.Node.value:type_name -> hoverhuang.azb.v1.CRDTValue
	0, // 2: hoverhuang.azb.v1.SQLiteValue.Type:type_name -> hoverhuang.azb.v1.Type
	4, // 3: hoverhuang.azb.v1.CRDTValue.Value:type_name -> hoverhuang.azb.v1.Row
	6, // 4: hoverhuang.azb.v1.Row.ColumnValues:type_name -> hoverhuang.azb.v1.Row.ColumnValuesEntry
	7, // 5: hoverhuang.azb.v1.Row.DeleteUpdateOffset:type_name -> google.protobuf.Duration
	7, // 6: hoverhuang.azb.v1.ColumnValue.UpdateOffset:type_name -> google.protobuf.Duration
	2, // 7: hoverhuang.azb.v1.ColumnValue.Value:type_name -> hoverhuang.azb.v1.SQLiteValue
	5, // 8: hoverhuang.azb.v1.Row.ColumnValuesEntry.value:type_name -> hoverhuang.azb.v1.ColumnValue
